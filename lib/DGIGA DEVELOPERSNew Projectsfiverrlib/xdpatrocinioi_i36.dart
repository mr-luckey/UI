...
import './xdpatrocinioi_i39.dart';
import 'package:adobe_xd/page_link.dart';
import './xdpatrocinioi_i31.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDPATROCINIOII36 extends StatelessWidget {
  XDPATROCINIOII36({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 137.0, start: 10.0),
            Pin(size: 21.0, middle: 0.4),
            child: Text(
              'Tuneado de coches',
              style: TextStyle(
                fontFamily: 'Avenir',
          ...
          Pinned.fromPins(
            Pin(size: 102.0, start: 10.0),
            Pin(size: 21.0, middle: 0.4526),
            child: Text(
              'Coche de niño',
              style: TextStyle(
                fontFamily: 'Avenir',
          ...
          Pinned.fromPins(
            Pin(size: 77.0, start: 10.0),
            Pin(size: 21.0, middle: 0.5577),
            child: Text(
              'Coches.net',
              style: TextStyle(
                fontFamily: 'Avenir',
          ...
          Pinned.fromPins(
            Pin(size: 132.0, start: 10.0),
            Pin(size: 21.0, middle: 0.6103),
            child: Text(
              'Seguros de coches',
              style: TextStyle(
                fontFamily: 'Avenir',
