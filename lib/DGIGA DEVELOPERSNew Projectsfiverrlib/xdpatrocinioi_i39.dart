...
class XDPATROCINIOII39 extends StatelessWidget {
  XDPATROCINIOII39({
    Key? key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromPins(
            ...
            Pin(size: 61.0, middle: 0.2755),
            child: Container(
              color: const Color(0xff5c5c5c),
            ),
          ),
          Pinned.fromPins(
            Pin(size: 98.0, middle: 0.2215),
          ...
          Pinned.fromPins(
            Pin(size: 59.0, start: 58.0),
            Pin(size: 20.0, middle: 0.2842),
            child: Text(
              'Intereses',
              style: TextStyle(
                fontFamily: 'Avenir',
          ...
          Pinned.fromPins(
            Pin(size: 332.0, start: 14.0),
            Pin(size: 39.0, middle: 0.3407),
            child: Text(
              'Te sugerimos que añadas una gran variedad de\nintereses para llegar a la audiencia más amplia.',
              style: TextStyle(
                fontFamily: 'Avenir',
                fontSize: 16,
                color: const Color(0xffffffff),
          ...
          Pinned.fromPins(
            Pin(size: 103.0, start: 14.0),
            Pin(size: 24.0, middle: 0.4071),
            child: Text(
              'Tus intereses',
              style: TextStyle(
                fontFamily: 'Avenir',
          ...
          Pinned.fromPins(
            Pin(size: 71.0, start: 14.0),
            Pin(size: 21.0, middle: 0.5257),
            child: Text(
              'Vehículos ',
              style: TextStyle(
                fontFamily: 'Avenir',
          ...
          Pinned.fromPins(
            ...
            Pin(size: 1.0, middle: 0.2995),
            child: Container(
              color: const Color(0xff6fd373),
            ),
          ),
          Pinned.fromPins(
            Pin(size: 23.8, end: 13.7),
            Pin(size: 23.8, middle: 0.4672),
            child: Stack(
              children: <Widget>[
                Stack(
                  children: <Widget>[
...
const String _svg_v3eprg =
    '<svg viewBox="375.5 285.5 23.8 23.8" ><path transform="translate(375.45, 285.47)" d="M 11.92053318023682 0 C 18.50406074523926 0 23.84106636047363 5.337004661560059 23.84106636047363 11.92053318023682 C 23.84106636047363 18.50406074523926 18.50406074523926 23.84106636047363 11.92053318023682 23.84106636047363 C 5.337004661560059 23.84106636047363 0 18.50406074523926 0 11.92053318023682 C 0 5.337004661560059 5.337004661560059 0 11.92053318023682 0 Z" fill="none" stroke="#6fd373" stroke-width="2" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_x0r59 =
    '<svg viewBox="377.7 357.8 16.5 11.8" ><path transform="translate(374.34, 352.25)" d="M 8.663824081420898 14.9573450088501 L 4.715956211090088 11.24971675872803 L 3.400000095367432 12.48559188842773 L 8.663824081420898 17.42909622192383 L 19.94345092773438 6.835875511169434 L 18.62749481201172 5.599999904632568 L 8.663824081420898 14.9573450088501 Z" fill="#6fd373" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
